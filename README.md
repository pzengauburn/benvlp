...
- benvlp_0.1.tar.gz: Version 0.1 provides functions rolem(), lem(), rlmm(), and summary()
    ...
    * rlmm(): linear mixed-effect models assuming t-distributed random errors
    * summary(): compute BIC, WAIC, posterior means, HPD intervals, etc 
